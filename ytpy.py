...
\t\t  (____/     |_|   (____/
\n****************************************************************
\n*             {c_end}By: {vm_ex}Mawii 2021{c_end}                 {cy_ex}*{c_end}
\n{cy_ex}*{c_end}  Github --> {vm_ex}https://github.com/gbcode98{c_end}     {cy_ex}*{c_end}
\n{cy_ex}*{c_end}\t\t      {vm_ex}https://github.com/gbcode98{c_end}                      {cy_ex}*{c_end}
\n{cy_ex}****************************************************************
{c_end}""")
